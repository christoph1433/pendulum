...
int main(int argc, char** argv){
  ...
  input_subscriber = node.subscribe("/swing_up/y_input_transformed", 1000, MsgCallback2);
  control_publisher = node.advertise<std_msgs::Float32>("/swing_up/roll_input", 1000);
